...
public enum CustomEntity {
	...
	CUSTOMVILLAGER(CustomVillager.class, 120, "CustomVillager");
	...
	public static void clearCustomEntities(String worldName_) {
		for (org.bukkit.entity.Entity entity : Bukkit.getWorld(worldName_).getEntities()) {
			if(((CraftEntity)entity).getHandle() instanceof CustomVillager) {
				entity.remove();
			}
		}
	}
